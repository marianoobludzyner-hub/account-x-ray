...
Part of the same open-source series as [nrr-leak-diagnostic](https://github.com/marianoobludzyner-hub/nrr-leak-diagnostic), [renewal-risk-rollup](https://github.com/marianoobludzyner-hub/renewal-risk-rollup), [call-proactivity-analyzer](https://github.com/marianoobludzyner-hub/call-proactivity-analyzer), and [mariano-mentor](https://github.com/marianoobludzyner-hub/mariano-mentor), by [Mariano Obludzyner](https://github.com/marianoobludzyner-hub), founder of Obludzyner & Co. Those tools work at the company or portfolio level. This one goes deep on a single account, and reads unstructured sources, not just a spreadsheet row.
